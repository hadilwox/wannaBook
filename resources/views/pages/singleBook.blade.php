...
@section('content')
    <div class="app">
        ...
        <div class="shareModal absolute  py-2 px-3">

            <div id="shareModal" tabindex="-1"
                class="hidden overflow-y-auto overflow-x-hidden fixed top-80 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                <div class="relative p-4 w-full max-w-md max-h-full">
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <button id="copyBtn" title="copy url"
                        ...
                        <input type="text" id="copytext" name="message" readonly dir="ltr"
        ...
        <section class="main container p-10">
            <div class="flex justify-center mb-6">
                <span id="bookId" class="hidden">{{ $book->id }}</span>
            ...
            <div class="mb-6 flex justify-center">
                <div class="likeShareComment flex justify-between w-64  items-center ">
                    ...
                    <div class="share hover:bg-teal-500 p-1 rounded-md transition-all">
                        <svg id="shareBtn" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                    ...
                    <div class="like hover:bg-teal-500 p-1 rounded-md transition-all relative">
                        <svg id="likeBtn" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24"
                            stroke-width="1.5" stroke="currentColor" class="size-8 text-gray-100 ">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z" />
                        </svg>
                        <span id="countLike" class="text-white text-xs absolute top-3 left-12">{{ $book->like }}</span>
